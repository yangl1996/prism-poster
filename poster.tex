...
\begin{column}{\colwidth}
  ...
  \begin{block}{The longest chain protocol}
    ...
    \begin{figure}
      \centering
      \subcaptionbox{The longest chain protocol}{\input{longest-chain.tex}}
      \subcaptionbox{The Prism protocol}{\input{prism-chains.tex}}
    ...
    \begin{figure}
      ...
      \caption{Performance of Prism, Algorand, and the longest chain protocol. Curves represent tradeoff.}
    \end{figure}
